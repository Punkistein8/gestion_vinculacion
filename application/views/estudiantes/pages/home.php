<?php if ($this->session->userdata('usuario')->tipo_usu == 'ESTUDIANTE') : ?>
  <div class="order-lg-1 w-100" style="height: 100vh;">
    <img style="clip-path: polygon(25% 0%, 100% 0%, 100% 99%, 0% 100%); height: 100vh;" src="https://images.unsplash.com/photo-1604537529428-15bcbeecfe4d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1469&q=80" sizes="(max-width: 1080px) 100vw, 1080px" width="2160" height="768">
  </div>
  <div class="col-lg-6 col-xl-5 text-center text-lg-start pt-lg-5 mt-xl-4">
    ...
    <div class="lc-block mb-5">
      <div editable="rich">
        <p class="rfs-8">Aquí podrás verificar tu registro en tu empresa de Vinculación con la Sociedad.</p>
      </div>
    </div>
